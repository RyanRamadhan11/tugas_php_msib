      ...
      <div class="row">
        <div class="col-lg-12 d-flex justify-content-center">
          <ul id="portfolio-flters">
            ...
            <li data-filter=".filter-html">HTML, CSS & Bootstrap</li>
            <li data-filter=".filter-js">JavaScript</li>
            <li data-filter=".filter-ui">Design UI UX</li>
      ...
      <div class="row portfolio-container">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-js">
          <div class="portfolio-wrap">
            <img src="assets/img/portfolio/js_1.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Aplikasi Form Penjualan Barang</h4>
              <p>JavaScript</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-html">
          <div class="portfolio-wrap">
            <img src="assets/img/portfolio/html_1.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Landing Pages Web NF Computer</h4>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-ui">
          <div class="portfolio-wrap">
            <img src="assets/img/portfolio/ui_1.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Design Web NF Computer</h4>
              <p>Design UI UX</p>
              <div class="portfolio-links">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-php">
          <div class="portfolio-wrap">
            <img src="assets/img/portfolio/php_1.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Aplikasi Form Data Pegawai</h4>
              <p>PHP</p>
              <div class="portfolio-links">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-html">
          <div class="portfolio-wrap">
            <img src="assets/img/portfolio/html_2.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Landing Pages Web Portofolio</h4>
              <p>HTML, CSS & Bootstrap</p>
              <div class="portfolio-links">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-ui">
          <div class="portfolio-wrap">
            <img src="assets/img/portfolio/ui_2.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Design Web Interaktif</h4>
              <p>Design UI UX</p>
              <div class="portfolio-links">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-js">
          <div class="portfolio-wrap">
            <img src="assets/img/portfolio/js_2.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Aplikasi Informasi Data Gempa</h4>
              <p>JavaScript</p>
              <div class="portfolio-links">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-php">
          <div class="portfolio-wrap">
            <img src="assets/img/portfolio/php_2.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Aplikasi Data Nilai Mahasiswa</h4>
              <p>PHP</p>
              <div class="portfolio-links">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-php">
          <div class="portfolio-wrap">
            <img src="assets/img/portfolio/php_3.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Aplikasi Data Luas dan keliling Bidang Datar</h4>
              <p>PHP</p>
              <div class="portfolio-links">
